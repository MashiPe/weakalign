...
# from model.cnn_geometric_model_strong import CNNGeometric
...
for epoch in range(1, args.num_epochs+1):
    ...
    train_loss[epoch-1] = process_epoch('train',epoch,model,loss,optimizer,scheduler,dataloader,pair_generation_tnf,log_interval=100)
    model.FeatureRegression.eval()
    test_loss[epoch-1] = process_epoch('test',epoch,model,loss,optimizer,scheduler,dataloader_test,pair_generation_tnf,log_interval=100)
